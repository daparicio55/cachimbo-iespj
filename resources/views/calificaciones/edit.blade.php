<x-layouts.app title="Calificar Traje">
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        ...
        <div class="w-full rounded-xl p-4">
            <form action="{{ route('dashboard.calificar.update',$traje->id) }}" method="post" class="w-full">
                @csrf
                @method('PUT')
                ...
                <div class="grid gap-2 sm:grid-cols-3">
                    @foreach ($items_calificacion as $key2 => $item)
                        <div class="border border-neutral-200 dark:border-neutral-700 rounded p-4">
                            ...
                            <p class="text-sm text-neutral-500 dark:text-neutral-400 text-center mt-2 border-t-2 border-neutral-200 dark:border-neutral-700 py-1 bg-neutral-100 dark:bg-neutral-800 rounded">
